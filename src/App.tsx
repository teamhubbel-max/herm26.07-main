 ...
 * ==========================================================================
 * 
 * Корневой компонент TeamHub, управляющий маршрутизацией и состоянием.
 * Координирует работу всех модулей системы.
 * 
 * АРХИТЕКТУРА:
 * - Централизованное управление состоянием
 * - Условная отрисовка компонентов по activeView
 * - Проброс данных и обработчиков в дочерние компоненты
 * - Обработка авторизации и загрузки
 * 
 * СОСТОЯНИЯ ПРИЛОЖЕНИЯ:
 * - loading: проверка авторизации
 * - не авторизован: показ AuthPage
 * - авторизован: показ основного интерфейса
 * 
 * ПРЕДСТАВЛЕНИЯ (VIEWS):
 * - projects: галерея проектов (ProjectsLobby)
 * - projectBoard: доска конкретного проекта (ProjectBoard)
 * - documents: управление документами (DocumentsSection)
 * - analytics: аналитика и отчеты (Dashboard)
 * - marketing: анализ конкурентов (MarketingSection)
 * 
 * КОМПОНЕНТЫ ИНТЕРФЕЙСА:
 * - Sidebar: боковая навигация (всегда видна)
 * - Header: заголовок с поиском (скрыт на главной)
 * - Основной контент: зависит от activeView
 * - SettingsModal: модальное окно настроек
 * 
 * ДАННЫЕ:
 * - projects: список проектов пользователя
 * - board: Kanban доска текущего проекта
 * - documents: документы и шаблоны
 * - currentProject: активный проект для детального просмотра
 */
function App() {
