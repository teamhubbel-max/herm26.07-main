 ...
 * ==========================================================================
 * 
 * Главное меню приложения с навигацией по разделам.
 * Поддерживает сворачивание и режим "назад к проектам".
 * 
 * ФУНКЦИОНАЛЬНОСТЬ:
 * - Переключение между основными разделами
 * - Сворачивание/разворачивание панели
 * - Кнопка "Назад" при просмотре проекта
 * - Активное состояние текущего раздела
 * 
 * РАЗДЕЛЫ:
 * - Проекты (основной раздел)
 * - Документы (создание и управление документами)
 * - Аналитика (статистика и отчеты)
 * - Маркетинг (анализ конкурентов)
 * - Настройки и помощь
 * 
 * АНИМАЦИИ:
 * - Slide-in/out при сворачивании
 * - Hover эффекты для пунктов меню
 * - Активная полоска у выбранного пункта
 * - Плавные переходы иконок
 */
