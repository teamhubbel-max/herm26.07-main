...
/**
 * ==========================================================================
 * KANBAN ДОСКА (BOARD COMPONENT)
 * ==========================================================================
 * 
 * Основной компонент для отображения задач в виде Kanban доски.
 * Поддерживает drag & drop, фильтрацию и управление задачами.
 * 
 * ФУНКЦИОНАЛЬНОСТЬ:
 * - Drag & Drop задач между колонками
 * - Фильтрация задач по поисковому запросу
 * - Быстрое создание задач в конкретной колонке
 * - Статистика по задачам
 * - Информация о проекте и команде
 * 
 * КОЛОНКИ:
 * - К выполнению (todo): новые задачи
 * - В работе (inprogress): активные задачи
 * - В работе 2 (inprogress2): дополнительная колонка
 * - Выполнено (done): завершенные задачи
 * 
 * ДИЗАЙН:
 * - Цветовая индикация колонок
 * - Счетчики задач в заголовках
 * - Информационная панель проекта
 * - Адаптивная сетка для мобильных
 * 
 * АНИМАЦИИ:
 * - Плавное перемещение задач
 * - Подсветка drop-зон при перетаскивании
 * - Анимация создания новых задач
 */
