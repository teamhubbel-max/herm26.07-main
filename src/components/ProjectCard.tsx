 ...
 * ==========================================================================
 * 
 * Компонент отображения проекта в галерее проектов.
 * Показывает ключевую информацию и предоставляет быстрые действия.
 * 
 * ФУНКЦИОНАЛЬНОСТЬ:
 * - Отображение статуса и роли пользователя
