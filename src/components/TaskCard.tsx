 ...
 * ==========================================================================
 * 
 * Компонент отображения задачи в виде стикера с возможностью перетаскивания.
 * Поддерживает два режима отображения: полный и компактный.
 * 
 * ФУНКЦИОНАЛЬНОСТЬ:
 * - Drag & Drop с помощью react-beautiful-dnd
 * - Контекстное меню для редактирования/удаления
 * - Индикаторы приоритета и статуса
 * - Отображение дедлайнов с цветовой индикацией
 * - Модальное окно с деталями задачи
 * 
 * ДИЗАЙН:
 * - Стиль стикеров с эффектом бумаги
 * - Градиентные фоны в зависимости от приоритета
 * - Анимации при наведении и перетаскивании
 * - Кнопка-гвоздик для аутентичности стикера
 * 
 * АНИМАЦИИ:
 * - Покачивание при hover (:hover rotate)
 * - Увеличение и поворот при перетаскивании
 * - Плавные переходы всех свойств
 * - Pulsing эффект для urgent задач
 */
