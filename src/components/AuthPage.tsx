 ...
 * ==========================================================================
 * 
 * Компонент для входа и регистрации пользователей в системе TeamHub.
 * Поддерживает только email/password авторизацию без внешних провайдеров.
 * 
 * ФУНКЦИОНАЛЬНОСТЬ:
 ...
 * 
 * АНИМАЦИИ:
 * - Плавное появление формы (fadeIn)
