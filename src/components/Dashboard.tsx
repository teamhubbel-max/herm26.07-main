 ...
 * ==========================================================================
 * 
 * Центральная панель с аналитикой по всем проектам пользователя.
 * Отображает статистику, KPI участников и графики динамики.
 * 
 * БЛОКИ ИНФОРМАЦИИ:
 * 1. Общая статистика (карточки с цифрами)
 * 2. Задачи высокого приоритета (список)
 * 3. Приближающиеся дедлайны (список с датами)
 * 4. KPI участников (карусель с метриками)
 * 5. Последние события (лента активности)
 * 6. Ключевые показатели (фильтруемые метрики)
 * 7. Динамические графики (Chart.js)
 * 
 * ИНТЕРАКТИВНОСТЬ:
 * - Клик по задачам открывает детали
 * - Переход к проектам по кнопке
 * - Фильтрация по датам и проектам
 * - Переключение типов графиков
 * 
 * АНИМАЦИИ:
 * - Анимация появления карточек
 * - Карусель KPI с кнопками навигации
